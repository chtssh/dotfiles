...
static char *cachefolder    = "~/.cache/surf/";
...
static guint defaultfontsize = 14;   /* Default font size */
...
/* Quick searching. */
#define QSEARCH { \
	.v = (char *[]){"/bin/sh", "-c", "~/.config/surf/qsearch $0 $1", winid, NULL } \
}
...
#define BM_PICK { \
	.v = (char *[]){ "/bin/sh", "-c", \
		...
		`cat ~/.config/surf/bookmarks | dmenu || exit 0`", \
		winid, NULL \
	} \
}
...
static Key keys[] = {
	...
	{ MODKEY,               GDK_bracketright, scroll_h,   { .i = +1 } },
	{ MODKEY,               GDK_bracketleft,  scroll_h,   { .i = -1 } },
	...
	{ MODKEY|GDK_SHIFT_MASK,GDK_z,            togglescrollbars, { 0 } },
	{ MODKEY|GDK_SHIFT_MASK,GDK_g,            togglegeolocation, { 0 } },
	{ MODKEY,               GDK_f,            spawn,      QSEARCH },
